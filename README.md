...
- **🗣️ 양방향 음성 대화**: 말로 질문하고 음성으로 답변 받기
- **🤖 AI 대화**: OpenAI GPT를 활용한 자연스러운 한국어 대화
- **🎤 음성 인식**: OpenAI Whisper를 통한 정확한 Speech-to-Text
...
1. 🎤 마이크 버튼 클릭
2. 마이크 권한 허용
3. 음성으로 질문하기 (빨간색 애니메이션 중)
4. 다시 🎤 버튼 클릭하여 녹음 종료
5. 자동으로 음성이 텍스트로 변환되어 AI에게 전송
6. AI 응답을 텍스트와 음성으로 동시에 받기
